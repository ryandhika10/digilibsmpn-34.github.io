            ...
            <div class="col-lg-9 col-md-12 container">
                <div class="row reset_password-form bg-light rounded shadow">
                    ...
                    <div class="col-lg-7 col-md-6 p-4">
                        ...
                        @endif
                        @if (session()->has('reset_passwordError'))
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                {{ session('reset_passwordError') }}
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                        @endif
                        @include('layouts/flash')
                        <main class="form-reset_password">
                            <h1 class="h3 mb-sm-3 mb-lg-4 fw-normal text-center heading">Reset Password</h1>
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-lg-10 col-md-12">
                                        <div class="form-sm mb-3">
                                            <input type="email" name="email" class="form-control @error ('email') is-invalid @enderror" id="email" placeholder="Email" required value="{{ $email ?? old('email') }}">
                                            @error('email')
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="w-100 btn btn-sm btn-primary button-reset_password mt-3 subheading" type="submit"><i class="fa-solid fa-file-pen"></i> Reset Password</button>
                                            </div>
                                        </div>
                                        <hr>
                                    </div>
